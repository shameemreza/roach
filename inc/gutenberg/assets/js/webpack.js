  ...
  ([
    ...
    (function(module, exports, __webpack_require__) {
      ...
      function addClass(element, className) {
        ...
        else if (!(0, _hasClass2.default)(element)) element.className = element.className + ' ' + className;
      }
      module.exports = exports['default'];
      /***/
    }),
    ...
    (function(module, exports, __webpack_require__) {
      ...
      module.exports = function removeClass(element, className) {
        ...
        else element.className = element.className.replace(new RegExp('(^|\\s)' + className + '(?:\\s|$)', 'g'), '$1').replace(/\s+/g, ' ').replace(/^\s*|\s*$/g, '');
      };
      /***/
    }),
    /* 14 */
