...
register_nav_menus(array(
  'header-menu' => __('Main menu', 'roach'),
));
...
if (!$thumb_width) : $thumb_width = 400;
endif;

$thumb_height = get_theme_mod('roach_thumb_height');
if (!$thumb_height) : $thumb_height = 267;
endif;
...
if (!$side_thumb_width) : $side_thumb_width = 300;
endif;

$side_thumb_height = get_theme_mod('roach_side_thumb_height');
if (!$side_thumb_height) : $side_thumb_height = 140;
endif;
...
function add_widget_support()
{
  ...
  register_sidebar(array(
    ...
    'id'            => 'social',
    'description'    => __('Location for the links to your social networks.', 'roach'),
    'before_widget' => '<div>',
    'after_widget'  => '</div>',
    'before_title'  => '<p class="sidebar-title">',
    'after_title'   => '</p>',
...
function roach_breadcrumbs_pages($post, $schema)
{
  ...
  if (!get_theme_mod('roach_hide_breadcrumb_page') && !get_post_meta(get_the_ID(), 'hide_breadcrumbs', true)) {
  ...
  if (!is_admin() && !current_user_can('manage_options')) {
    ...
    if ($roach_jquery_options) {
      ...
      if ($roach_jquery_options == 1) {
        ...
        wp_register_script('jquery', ("https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"), true);
...
function roach_load_scripts()
{
  ...
  if ((get_theme_mod('roach_no_sticky_header')) &&  (!get_theme_mod('roach_float_menu'))) :
...
function roach_extract($length)
{
  ...
  if (!$extract_long) : $extract_long = 12;
  endif;
...
add_filter('heartbeat_settings', 'roach_heartbeat_limit');
  ...
  <table class="form-table">
    <tr class="form-field">
      <th scope="row" valign="top">
        <label for="description"><?php _e('Bottom Description', 'roach'); ?></label>
      </th>
      <td>
        <?php
        $settings = array(
        ...
        ?>
        <br />
        <span class="description"><?php _e('This description will be displayed below the list of entries.', 'roach'); ?></span>
      </td>
    </tr>
  </table><?php
        }
 ...
 */
        ...
        add_action('after_setup_theme', 'roach_woocommerce_support');
        ...
        function roach_optimize_video($str, $data, $url)
        {
          if (get_theme_mod('roach_optimize_youtube')) {
            if (($yt = $data->provider_name == 'YouTube') || ($vm = $data->provider_name == 'Vimeo')) {
              ...
              return '<div onclick="this.outerHTML=\'' . $html . '\'"><img src="' . $img . '"  title="' . $title . '" class="roach-oembed"></div>';
            }
          }
          return $str;
        }
        ...
        function roach_clean_cache_menu($wp_admin_bar)
        {
          ...
          $wp_admin_bar->add_menu(
            [
              ...
              'href'   => wp_nonce_url(admin_url('admin-post.php?action=clean_cache_roach' . $referer)),
            ]
          );
        }
 ...
 */
	 ...
	 */
          if ($place == 1 && $show_ads && !$hide_ads) {
            ...
            if ($ads_before) :
              ...
              if ((in_array($ads_before_cat, $cats)) || (!$ads_before_cat)) :
                ...
                if (!$ads_before_style) : $ads_before_style = 'ads-roach-aligncenter';
                endif;

                if (!$ads_before_type) : $ads_before_type = '2';
                endif;

                if ($ads_before_margin) : $ads_before_style_margin = '" style="padding:' . $ads_before_margin . 'px';
                endif;

                switch ($ads_before_device):

                  case 2:
                    $ads_before_style = $ads_before_style . ' ads-roach-desktop';
                    break;

                  case 3:
                    $ads_before_style = $ads_before_style . ' ads-roach-mobile';
                    break;
          ...
          <div class="ads-roach <?php echo $ads_before_style . $ads_before_style_margin; ?>">
	 ...
	 */
          if ($place == 2 && $show_ads && !$hide_ads) {
            ...
            if ($ads_after) :
              ...
              if ((in_array($ads_after_cat, $cats)) || (!$ads_after_cat)) :
                ...
                if (!$ads_after_style) : $ads_after_style = 'ads-roach-aligncenter';
                endif;

                if (!$ads_after_type) : $ads_after_type = '2';
                endif;

                if ($ads_after_margin) : $ads_after_style_margin = '" style="padding:' . $ads_after_margin . 'px';
                endif;
                ...
                switch ($ads_after_device):
                  ...
                  case 2:
                    ...
                    $ads_after_style = $ads_after_style . ' ads-roach-desktop';

                    break;

                  case 3:

                    $ads_after_style = $ads_after_style . ' ads-roach-mobile';
          ...
          <div class="ads-roach <?php echo $ads_after_style . $ads_after_style_margin; ?>">
	 ...
	 */
          if ($place == 3 && $show_ads && !$hide_ads) {
            ...
            $ads_before_sidebar = base64_decode(get_theme_mod('roach_ads_before_sidebar'));

            if ($ads_before_sidebar) :

              $ads_before_sidebar_cat = get_theme_mod('roach_ads_before_sidebar_cat');

              if ((in_array($ads_before_sidebar_cat, $cats)) || (!$ads_before_sidebar_cat)) :

                $ads_before_sidebar_device = get_theme_mod('roach_ads_before_sidebar_device');
                ...
                $show_home  = get_theme_mod('roach_ads_before_sidebar_show_home');
                $show_cats  = get_theme_mod('roach_ads_before_sidebar_show_cats');
                $show_tags  = get_theme_mod('roach_ads_before_sidebar_show_tags');
                $show_posts = get_theme_mod('roach_ads_before_sidebar_show_posts');
                $show_pages = get_theme_mod('roach_ads_before_sidebar_show_pages');
	 ...
	 */
          if ($place == 4 && $show_ads && !$hide_ads) {
            ...
            $ads_after_sidebar = base64_decode(get_theme_mod('roach_ads_after_sidebar'));

            if ($ads_after_sidebar) :

              $ads_after_sidebar_cat = get_theme_mod('roach_ads_after_sidebar_cat');

              if ((in_array($ads_after_sidebar_cat, $cats)) || (!$ads_after_sidebar_cat)) :

                $ads_after_sidebar_device = get_theme_mod('roach_ads_after_sidebar_device');
                ...
                $show_posts = get_theme_mod('roach_ads_after_sidebar_show_posts');
                $show_pages = get_theme_mod('roach_ads_after_sidebar_show_pages');
	 ...
	 */
          if ($place == 5 && $show_ads && !$hide_ads) {
            ...
            if ($ads_header) :
              ...
              if ((in_array($ads_header_cat, $cats)) || (!$ads_header_cat)) :
                ...
                if ($ads_header_margin) : $ads_header_style_margin = '" style="padding:' . $ads_header_margin . 'px';
                endif;
        ...
        ?>
          ...
          <div class="ads-roach ads-roach-top ads-roach-aligncenter <?php echo $ads_header_style . $ads_header_style_margin; ?>">
	 ...
	 */
          if ($place == 6 && $show_ads && !$hide_ads) {
            ...
            $ads_before_image =   base64_decode(get_theme_mod('roach_ads_before_image'));
            ...
            if ($ads_before_image) :
              ...
              if ((in_array($ads_before_image_cat, $cats)) || (!$ads_before_image_cat)) :
                ...
                $ads_before_image_style   = get_theme_mod('roach_ads_before_image_style');

                $ads_before_image_type   = get_theme_mod('roach_ads_before_image_type');

                $ads_before_image_device  = get_theme_mod('roach_ads_before_image_device');

                $ads_before_image_margin  = get_theme_mod('roach_ads_before_image_margin');

                $ads_before_image_style_margin   = '';

                if (!$ads_before_image_style) : $ads_before_image_style = 'ads-roach-aligncenter';
                endif;

                if (!$ads_before_image_type) : $ads_before_image_type = '2';
                endif;

                if ($ads_before_image_margin) : $ads_before_image_style_margin = '" style="padding:' . $ads_before_image_margin . 'px';
                endif;

                switch ($ads_before_image_device):

                  case 2:
                    $ads_before_image_style = $ads_before_image_style . ' ads-roach-desktop';
                    break;

                  case 3:
                    $ads_before_image_style = $ads_before_image_style . ' ads-roach-mobile';
                    break;
          ...
          <div class="ads-roach <?php echo $ads_before_image_style . $ads_before_image_style_margin; ?>">
 ...
 */
        ...
        function roach_show_author()
        {
          ...
          if ((get_theme_mod('roach_show_author') && is_single()) ||
    ...
    <div class="content-author">
      ...
      <div class="author-desc">
        <p>
          <?php if (is_single() && !get_theme_mod('roach_deactivate_author_link')) { ?>
          ...
          <?php
            if (
              ...
              if ($post_date != $post_modified) {
                echo '<span class="roach-post-update"> - Actualizado: ' . $post_modified . '</span>';
              }
  ...
  <?php endif;
        ...
        function roach_show_author_box()
        {
          ...
          if ((get_theme_mod('roach_show_box_author') && is_single()) ||
 ...
 */
        ...
        add_action('pre_get_posts', 'roach_tags_support_query');
 ...
 */
        ...
        add_action('wp_enqueue_scripts', 'roach_delete_global_styles');
            ...
            if ($ads_loop_1) {
              ...
              if ($count == $show) {
                ...
                if ((is_home() && $show_home) || (is_category() && $show_cats) || (is_tag() && $show_tags)) {
                  $ads_loop_1_device = get_theme_mod('roach_ads_loop_1_device');
            ...
            if ($ads_loop_2) {
              ...
              if ($count == $show) {
                ...
                if ((is_home() && $show_home) || (is_category() && $show_cats) || (is_tag() && $show_tags)) {
                  ...
                  $ads_loop_2_device = get_theme_mod('roach_ads_loop_2_device');
        ...
        <?php
            ...
            if ($ads_loop_3) {
              ...
              if ($count == $show) {
                ...
                if ((is_home() && $show_home) || (is_category() && $show_cats) || (is_tag() && $show_tags)) {
                  $ads_loop_3_device = get_theme_mod('roach_ads_loop_3_device');
        ...
        <?php
            ...
            if ($ads_loop_4) {
              ...
              if ($count == $show) {
                ...
                if ((is_home() && $show_home) || (is_category() && $show_cats) || (is_tag() && $show_tags)) {
                  $ads_loop_4_device = get_theme_mod('roach_ads_loop_4_device');
        ...
        <?php
            ...
            if ($ads_loop_5) {
              ...
              if ($count == $show) {
                ...
                if ((is_home() && $show_home) || (is_category() && $show_cats) || (is_tag() && $show_tags)) {
                  $ads_loop_5_device = get_theme_mod('roach_ads_loop_5_device');
 ...
 */
        ...
        function roach_show_dynamic_single()
        {
          ...
          if (get_theme_mod('roach_show_last_paragraph_single')) {
            ...
            if (!$str) {
              $str = 'If you want to know other articles similar to %%title%% you can visit the category %%category%%.';
            }
 ...
 */
        ...
        function roach_show_hero()
        {
          ...
          $subtitle   = '<p>' . get_post_meta($post->ID, 'subtitle_post', true) . '</p>';
