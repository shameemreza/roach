...
<?php if (get_theme_mod('roach_show_search')) : ?>

  <div class="search-header">

    <form action="<?php echo esc_url(home_url('/')); ?>" method="get">

      <input autocomplete="off" id="search-header" placeholder="<?php echo $roach_search_text; ?>" value="<?php echo get_search_query() ?>" name="s" required>
